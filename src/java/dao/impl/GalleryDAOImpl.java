...
/**
 * This class has methods for retrieving data from galery table in database. The
...
public class GalleryDAOImpl extends DBContext implements GalleryDAO {
    ...
    /**
     * Find the list Gallery in the top "number" from galery table in database.
     * The result contain a list of <code>Gallery</code> objects with id, title,
     * description, name
     *
     ...
     * of <code>Gallery</code> objects with id, title, description, name
     *
    ...
    /**
     * Get number of Gallery from galery table in database. Number of Gallery
