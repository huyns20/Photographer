...
public class ImageDAOImpl extends DBContext implements ImageDAO {
    ...
    /**
     * Get number of Image from image table in database. All the Images have
     * Gallery ID matches with searched id will be returned. The result contain
     * an int number.
     *
     ...
     * returned. The result contain a list of <code>entity.Image</code> objects
     * with id, galleryId, imageUrl
     *
     ...
     * contain a Image of <code>entity.Image</code> objects with id, galleryId,
     * imageUrl
     *
     ...
     * a image of <code>entity.Image</code> objects with id, galleryId, imageUrl
     *
     * @param galleryId the id of Gallery. It is an int number
     * @return a Image of <code>Image</code> objects. It is a
     * <code>entity.Image</code> object
